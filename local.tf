locals {
  ...
  # The name of the ECS postservice to be created
  aws_ecs_postservice_name = "${var.aws_resource_prefix}-postservice"
  # The name of the ECS postservice to be created
  aws_ecs_userservice_name = "${var.aws_resource_prefix}-userservice"
}
